    ...
    public static void ObjectLayer(World game, MapLayers layers) {
        ...
        for(MapLayer layer : layers) {
            ...
            for (MapObject object : objects) {
                ...
                //Fixture fixture;
                //The wall layer in Tiled itelf should have a "Solid" property added to it
                //if (layer.getProperties().containsKey("Solid"))
                if (layer.getName().contentEquals("Walls") || layer.getName().contentEquals("Wall"))
                    //fixture = body.createFixture(fDef);
                    body.createFixture(fDef);

                    //The mud layer in Tiled itself should have a "Slow" property added to it
                    //else if (layer.getProperties().containsKey("Slow")) {
