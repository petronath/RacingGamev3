...
import static com.racing.game3.extras.Constants.Window_W;
...
public class Menu implements Screen{
    ...
    public Menu(RacingGamev3 game) {
        ...
        g.menu = new TmxMapLoader().load("maps/TiledMenu2.tmx");
    ...
    public void resize(int width, int height) {
        ...
        //g.cam.setToOrtho(false, width*2.6f, height*2.6f);	//zooms out camera view after map is rendered
